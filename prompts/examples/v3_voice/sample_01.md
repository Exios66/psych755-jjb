# Sample prompt — `v3_voice` tier (example 1)

- **Context combination tier:** `v3_voice`
- **Illustrative participant id:** `example_student_us_01`
- **Tier design:** `geo` base + Q18.1/Q19 voice only.
...
When a friend gets nervous talking to new people, you would advise: "Take a breath and remember they are just people too." Your ideal way to get around your city is: "Bus or train when I can; walking for short trips."
