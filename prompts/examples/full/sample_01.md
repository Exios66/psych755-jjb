...
Transportation use:
- In the last three months, on how many days did you use public transportation (bus, train, tram, etc.): 8 or more days a month
- On a typical day of public transportation use, how many rides do you take: 3-4 rides in a typical day
- In the last three months, on how many days did you use ride share platforms (Lyft, Uber, DiDi, etc.): 2-4 days a month
...
- Do you have access to a car you can use for transportation: No

Self-described attitudes (from survey free responses):
- Advice I would give a friend who gets nervous talking to new people: Take a breath before you speak and remember most people are focused on themselves, not judging you. Start with one short question and let the conversation grow from there.
- My ideal way to get around my city (and why): I prefer the bus and bike — I like not having to park, and riding with other people around campus feels easier than driving alone.
