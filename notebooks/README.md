...
| [`stage_one_ml_baseline.ipynb`](stage_one_ml_baseline.ipynb) | Stage one | Train/evaluate the full ML suite (Ridge, Elastic Net, k-NN, RF, HistGB, XGBoost, MLP) on the same tiered CA prediction task used for LLM personas |
