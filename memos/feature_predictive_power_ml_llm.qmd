...
: Rank / DeepSeek v2 surrogate mean \ / SHAP\. {#tbl-fp-4}
...
: Agent / Predicted band / n. {#tbl-fp-5}
...
![RF band confusion — Group CA (transit)](figures/fig_confusion_rf_group.png){#fig-fp-fig-confusion-rf-group} ![DeepSeek v2 band confusion — Group CA (transit)](figures/fig_confusion_llm_group.png){#fig-fp-fig-confusion-llm-group}
