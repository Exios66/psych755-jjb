...
**Parent memo:** [`geo_predicts_transit.md`](geo_predicts_transit.qmd) · **Companion:** [`country_car_predicts_transit.md`](country_car_predicts_transit.qmd)
...
3. Pairing country with car access *does* help—see [`country_car_predicts_transit.md`](country_car_predicts_transit.qmd).
