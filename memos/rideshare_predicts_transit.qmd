...
**Q27/Q28 focused memo:** [`q27_q28_predict_transit.md`](q27_q28_predict_transit.qmd) · manuscript § in [`index.qmd`](../index.qmd)  
...
Car access recovers AUC = **0.607** ([`car_access_predicts_transit.md`](car_access_predicts_transit.qmd)); the joint car+employment+ride-share bundle recovers AUC = **0.746** on n = 143 — only +0.002 over ride-share alone on that smaller complete-case subset ([`transit_covariate_followups.md`](transit_covariate_followups.qmd)).
