...
| [`comprehensive_predictors_transit.md`](comprehensive_predictors_transit.md) | Jack J. Burleson | Which available predictors most powerfully discriminate regular transit use (ROC-maximizing RF)? |
