...
**Companions:** [`ca_scores_predict_transit.md`](ca_scores_predict_transit.qmd) · [`q28_conditioned_on_car.md`](q28_conditioned_on_car.qmd) · [`residual_ca_after_rideshare.md`](residual_ca_after_rideshare.qmd)
...
Is the CA collapse on n=149 selection (who answers car items) or true redundancy with mobility? See also residual-CA strata in [`residual_ca_after_rideshare.md`](residual_ca_after_rideshare.qmd).
