...
Figure @fig-cp-comprehensive-predictors-transit shows permutation importance and the ROC curve for the tuned forest.
...
**Feature-group ablations.** Table @tbl-cp-1 reports the ablation comparisons.
