...
**Parent memo:** [`geo_predicts_transit.md`](geo_predicts_transit.qmd)  
**Comparison memo:** [`transit_covariate_followups.md`](transit_covariate_followups.qmd)
...
Ride-share frequency (`Q28`/`Q29`) recovers AUC = **0.745** ([`rideshare_predicts_transit.md`](rideshare_predicts_transit.qmd)). Employment status alone recovers AUC = **0.528** ([`employment_predicts_transit.md`](employment_predicts_transit.qmd)). Head-to-head: [`transit_covariate_followups.md`](transit_covariate_followups.qmd).
