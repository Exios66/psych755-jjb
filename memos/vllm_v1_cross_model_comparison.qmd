...
**Formal method pages:** [`docs/llm_baseline_llama31_v1.md`](../docs/llm_baseline_llama31_v1.md) · [`docs/llm_baseline_llama32_instruct_v1.md`](../docs/llm_baseline_llama32_instruct_v1.md) · [`docs/llm_baseline_deepseek_r1_distill_v1.md`](../docs/llm_baseline_deepseek_r1_distill_v1.md) · [`docs/llm_baseline_llama33_70b_v1.md`](../docs/llm_baseline_llama33_70b_v1.md) · [`docs/persona_prompt_versions.qmd`](../docs/persona_prompt_versions.qmd)

**Sibling memos (per model):** [`vllm_v1_llama31_8b.qmd`](vllm_v1_llama31_8b.qmd) · [`vllm_v1_llama32_3b.qmd`](vllm_v1_llama32_3b.qmd) · [`vllm_v1_deepseek_r1_distill.qmd`](vllm_v1_deepseek_r1_distill.qmd) · [`vllm_v1_llama33_70b.qmd`](vllm_v1_llama33_70b.qmd)

---

## Answer, Response, + Summary of Results

Using the Prolific↔Qualtrics matched analytic cohort (**n = 241**; inner join; complete scorable PRCA), we evaluated four GPU vLLM exports on **identical prompt-v1** Terrarium narratives (241 × 5 tiers = **1,205** prompts each; Table @tbl-v1x-1):
...
: vLLM v1 model specifications and hardware details. {#tbl-v1x-1}
...
: Head-to-head vLLM v1 pooled metrics across models. {#tbl-v1x-2}
...
Table @tbl-v1x-3 maps RQ1–RQ3 verdicts by model.
...
: RQ1-RQ3 response patterns by model. {#tbl-v1x-3}
...
The archived v2/v3 exports (`exports/v2/`, `exports/v3/`) answer the questions left open above. Pooled metrics (Table @tbl-v1x-4):
...
: v2/v3 prompt version pooled metrics. {#tbl-v1x-4}
...
Per-model memos below unpack RQ tables and confusion matrices. Classical ceilings: [`docs/ml_baselines.md`](../docs/ml_baselines.md). Feature attributions (mock LLM era): [`feature_predictive_power_ml_llm.qmd`](feature_predictive_power_ml_llm.qmd). Prompt redesign rationale: [`docs/persona_prompt_efficiency.md`](../docs/persona_prompt_efficiency.md).
