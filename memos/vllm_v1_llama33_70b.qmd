...
**Research question:** Does `meta-llama/Llama-3.3–70B-Instruct`, when personified via prompt-v1 cumulative Terrarium narratives ([@grossmann2023]), recover participants’ group and interpersonal PRCA scores — and do employment (RQ1), transit (RQ2), or full cumulative context (RQ3) reduce absolute error?
...
Table @tbl-v1l70-1 reports the mode-collapse diagnostics.
...
Table @tbl-v1l70-2 reports MAE and band metrics by tier.
