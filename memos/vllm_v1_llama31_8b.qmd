...
**Research question:** Does `meta-llama/Llama-3.1–8B-Instruct`, when personified via prompt-v1 cumulative Terrarium narratives ([@argyle2023]), recover participants’ group and interpersonal PRCA scores — and do employment (RQ1), transit (RQ2), or full cumulative context (RQ3) reduce absolute error?
...
Table @tbl-v1l31–1 situates observed metrics against exact/band chance and the ML floor.
...
Table @tbl-v1l31–2 reports MAE and band metrics by tier.
...
Figure @fig-v1l31-vllm-v1-llama31-ip-collapse plots Llama-3.1's interpersonal MAE and signed error by tier against DeepSeek's flat profile.
