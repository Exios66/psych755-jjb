...
Cross-model ranking: [`vllm_v1_cross_model_comparison.md`](vllm_v1_cross_model_comparison.qmd). Smaller Llama and DeepSeek distill siblings: [`vllm_v1_llama32_3b.md`](vllm_v1_llama32_3b.qmd), [`vllm_v1_deepseek_r1_distill.md`](vllm_v1_deepseek_r1_distill.qmd). Prompt redesign: [`docs/persona_prompt_efficiency.md`](../docs/persona_prompt_efficiency.md). Manuscript figure: `memos/figures/vllm_v1_llama31_ip_collapse.png`.
