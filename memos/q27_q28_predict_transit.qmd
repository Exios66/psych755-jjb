...
Using the Prolific↔Qualtrics matched analytic cohort (File A + File B joined to File C; base **n = 241** with complete PRCA and usable `Q26`), we define **regular transit** as `Q26` ∈ {`4–8 days a month`, `8 or more days a month`} (weekly-or-more). We then fit balanced ****Random Forest**s** with stratified 5-fold CV (`random_state=42`) using categorical one-hot encodings of:
