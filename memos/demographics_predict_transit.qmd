...
**Companion:** [`country_predicts_transit.md`](country_predicts_transit.qmd) · [`common_n_head_to_head.md`](common_n_head_to_head.qmd) · agenda [`docs/research_memo_agenda.md`](../docs/research_memo_agenda.md)
...
Does age remain predictive after conditioning on Q28 and car access on a common-*N* frame? (Partially answered in [`common_n_head_to_head.md`](common_n_head_to_head.qmd)—demographics fall near chance when mobility items are forced into the overlap.)
