...
**Research question:** Does the smaller `meta-llama/Llama-3.2–3B-Instruct` model recover PRCA group and interpersonal scores on the same prompt-v1 ladder as the 8B baseline ([@horton2023]) — and does it avoid the transit-induced interpersonal failure seen in Llama-3.1?
...
Table @tbl-v1l32–1 compares 3B-Instruct against 8B-Instruct on the same prompts.
...
: Llama-3.2–3B tier-level performance. {#tbl-v1l32–1}


### Metrics by tier

Table @tbl-v1l32–2 reports MAE and band metrics by tier.
...
Cross-model synthesis: [`vllm_v1_cross_model_comparison.qmd`](vllm_v1_cross_model_comparison.qmd). Llama-3.1 failure modes: [`vllm_v1_llama31_8b.qmd`](vllm_v1_llama31_8b.qmd). DeepSeek distill: [`vllm_v1_deepseek_r1_distill.qmd`](vllm_v1_deepseek_r1_distill.qmd).
