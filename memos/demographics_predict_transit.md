...
**Companion:** [`country_predicts_transit.md`](country_predicts_transit.md) · [`common_n_head_to_head.md`](common_n_head_to_head.md) · agenda [`docs/research_memo_agenda.md`](../docs/research_memo_agenda.md)
...
![Demographics prevalence and ROC](figures/demographics_followup_memo.png)
...
Does age remain predictive after conditioning on Q28 and car access on a common-*N* frame? (Partially answered in [`common_n_head_to_head.md`](common_n_head_to_head.md)—demographics fall near chance when mobility items are forced into the overlap.)
