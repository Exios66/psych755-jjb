...
5. **Stereotyping gaps remain measurable?** *Measured* — DeepSeek v2 slices (Sex/Student/Employment) are reported in [`index.qmd`](../index.qmd) and [`memos/live_llm_stereotyping_slices.qmd`](../memos/live_llm_stereotyping_slices.qmd) from `exports/v2/…/tables/stereotyping_by_*.csv`.
