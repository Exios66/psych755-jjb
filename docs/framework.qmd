...
| Model | Mixed / categorical balanced **Random Forest**s (RFs) + Welch strata where noted |
...
digital-twin narratives** (AI Terrarium framing [@chuang2026aiterrarium] — “You are a …”), not
...
Version map (v1 baseline → v2 packaging → v3 ablations): [`persona_prompt_versions.qmd`](persona_prompt_versions.qmd).  
